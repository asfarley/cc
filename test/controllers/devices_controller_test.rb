...
class DevicesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create device" do
    assert_difference("Device.count") do
      post devices_url, params: { device: { name: @device.name, state_id: @device.state_id } }
    end
  ...
  test "should update device" do
    patch device_url(@device), params: { device: { name: @device.name, state_id: @device.state_id } }
