...
class AudioRecordingsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create audio_recording" do
    assert_difference("AudioRecording.count") do
      post audio_recordings_url, params: { audio_recording: { command_id: @audio_recording.command_id, device_id: @audio_recording.device_id, duration_seconds: @audio_recording.duration_seconds, recorded_at: @audio_recording.recorded_at } }
    end
  ...
  test "should update audio_recording" do
    patch audio_recording_url(@audio_recording), params: { audio_recording: { command_id: @audio_recording.command_id, device_id: @audio_recording.device_id, duration_seconds: @audio_recording.duration_seconds, recorded_at: @audio_recording.recorded_at } }
