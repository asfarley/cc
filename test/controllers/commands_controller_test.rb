...
class CommandsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create command" do
    assert_difference("Command.count") do
      post commands_url, params: { command: { Device_id: @command.Device_id, command: @command.command, result: @command.result, trigger_time: @command.trigger_time, type: @command.type } }
    end
  ...
  test "should update command" do
    patch command_url(@command), params: { command: { Device_id: @command.Device_id, command: @command.command, result: @command.result, trigger_time: @command.trigger_time, type: @command.type } }
